...
public class Analyzer {
    ...
    // Add declaringClass for method_map and method for for cls_map
    public void buildClassAndMethod(Map<SootClass, ClassAttr> cls_map, Map<SootMethod, MethodAttr> method_map) {
        ...
        // mn.declaredClass = cls_map.getOrDefault(entry.getKey().getDeclaringClass(),
        // null);
    ...
    // Finer Call Graph, i.e. caller/callee, field, method
